...
public class FourierTransformer extends JFrame {
    ...
    public FourierTransformer() {
        ...
        try {
//            this.im = ImageIO.read(getClass().getResource("11.jpg"));
            File file = new File("/Users/zhangyongyu/Desktop/11.jpg");
...
//				System.out.println("dest " + j*h+i + ",  src " + i*w+j);
        ...
        try {
            ImageIO.write(imageAuth, "jpg", new File("12_result.jpeg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        this.update(g);
